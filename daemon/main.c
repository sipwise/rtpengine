...
static void options(int *argc, char ***argv) {
	...
	GOptionEntry e[] = {
		...
		{ "kernel-player",0,0,	G_OPTION_ARG_INT,	&rtpe_config.kernel_player,"todo","INT"},
		{ "kernel-player-media",0,0,G_OPTION_ARG_INT,	&rtpe_config.kernel_player_media,"todo","INT"},
