...
void ssrc_sender_report(u_int32_t, struct call *, const struct ssrc_sender_report *, const struct timeval *);
void ssrc_receiver_report(u_int32_t, u_int32_t, struct call *, const struct ssrc_receiver_report *,
