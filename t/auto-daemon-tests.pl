...
($sock_a, $sock_ax, $sock_b, $sock_bx, $sock_c, $sock_cx) = new_call(
	[qw(198.51.100.36 4200)], [qw(198.51.100.36 4201)],
	[qw(198.51.100.37 5200)], [qw(198.51.100.37 5201)],
	[qw(198.51.100.38 6200)], [qw(198.51.100.38 6201)],
);

($port_a, $port_ax) = offer('ICE + delayed endpoint learning + media-handover', { ICE => 'remove', flags => ['media-handover'] }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.36
...
a=ice-pwd:bd5e8b8d6dd8e1bc6
a=ice-ufrag:q2758e93
a=candidate:aaa 1 UDP 2130706431 198.51.100.36 4200 typ host
a=candidate:aaa 2 UDP 2130706430 198.51.100.36 4201 typ host
a=candidate:bbb 1 UDP 2130706175 198.51.100.37 5200 typ host
a=candidate:bbb 2 UDP 2130706174 198.51.100.37 5201 typ host
--------------------------------------
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
...
(undef, undef, $ufrag_a, $pwd_a) = answer('ICE + delayed endpoint learning + media-handover', { }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.38
...
# RTP plain -> ICE ok, now on alternate port
snd($sock_c, $port_a,  rtp(8, 3002, 5320, 0x1a04, "\x88" x 160));
rcv($sock_b, $port_c, rtpm(8, 3002, 5320, 0x1a04, "\x88" x 160));
...
# RTP plain -> ICE now on primary port
snd($sock_c, $port_a,  rtp(8, 3005, 5800, 0x1a04, "\x88" x 160));
rcv($sock_a, $port_c, rtpm(8, 3005, 5800, 0x1a04, "\x88" x 160));




($sock_a, $sock_ax, $sock_b, $sock_bx, $sock_c, $sock_cx) = new_call(
	[qw(198.51.100.36 4220)], [qw(198.51.100.36 4221)],
	[qw(198.51.100.37 5220)], [qw(198.51.100.37 5221)],
	[qw(198.51.100.38 6220)], [qw(198.51.100.38 6221)],
);

($port_a, $port_ax) = offer('ICE + heuristic endpoint learning + media-handover', { ICE => 'remove', 'endpoint-learning' => 'heuristic', flags => ['media-handover'] }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.36
...
a=ice-pwd:bd5e8b8d6dd8e1bc6
a=ice-ufrag:q2758e93
a=candidate:aaa 1 UDP 2130706431 198.51.100.36 4220 typ host
a=candidate:aaa 2 UDP 2130706430 198.51.100.36 4221 typ host
a=candidate:bbb 1 UDP 2130706175 198.51.100.37 5220 typ host
a=candidate:bbb 2 UDP 2130706174 198.51.100.37 5221 typ host
--------------------------------------
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
...
(undef, undef, $ufrag_a, $pwd_a) = answer('ICE + heuristic endpoint learning + media-handover', { 'endpoint-learning' => 'heuristic' }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.38
...
($sock_a, $sock_ax, $sock_b, $sock_bx, $sock_c, $sock_cx) = new_call(
	[qw(198.51.100.36 4240)], [qw(198.51.100.36 4241)],
	[qw(198.51.100.37 5240)], [qw(198.51.100.37 5241)],
	[qw(198.51.100.38 6240)], [qw(198.51.100.38 6241)],
);

($port_a, $port_ax) = offer('ICE + immediate endpoint learning + media-handover', { ICE => 'remove', 'endpoint-learning' => 'immediate', flags => ['media-handover'] }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.36
t=0 0
a=sendrecv
m=audio 4240 RTP/AVP 0
a=ice-pwd:bd5e8b8d6dd8e1bc6
a=ice-ufrag:q2758e93
a=candidate:aaa 1 UDP 2130706431 198.51.100.36 4240 typ host
a=candidate:aaa 2 UDP 2130706430 198.51.100.36 4241 typ host
a=candidate:bbb 1 UDP 2130706175 198.51.100.37 5240 typ host
a=candidate:bbb 2 UDP 2130706174 198.51.100.37 5241 typ host
--------------------------------------
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
...
(undef, undef, $ufrag_a, $pwd_a) = answer('ICE + immediate endpoint learning + media-handover', { 'endpoint-learning' => 'immediate' }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.38
...
($sock_a, $sock_ax, $sock_b, $sock_bx, $sock_c, $sock_cx) = new_call(
	[qw(198.51.100.36 4260)], [qw(198.51.100.36 4261)],
	[qw(198.51.100.37 5260)], [qw(198.51.100.37 5261)],
	[qw(198.51.100.38 6260)], [qw(198.51.100.38 6261)],
);

($port_a, $port_ax) = offer('ICE + off endpoint learning + media-handover', { ICE => 'remove', 'endpoint-learning' => 'off', flags => ['media-handover'] }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.36
t=0 0
a=sendrecv
m=audio 4260 RTP/AVP 0
a=ice-pwd:bd5e8b8d6dd8e1bc6
a=ice-ufrag:q2758e93
a=candidate:aaa 1 UDP 2130706431 198.51.100.36 4260 typ host
a=candidate:aaa 2 UDP 2130706430 198.51.100.36 4261 typ host
a=candidate:bbb 1 UDP 2130706175 198.51.100.37 5260 typ host
a=candidate:bbb 2 UDP 2130706174 198.51.100.37 5261 typ host
--------------------------------------
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
...
(undef, undef, $ufrag_a, $pwd_a) = answer('ICE + off endpoint learning + media-handover', { 'endpoint-learning' => 'off' }, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
s=tester
c=IN IP4 198.51.100.38
...
# RTP plain -> ICE now on alternate port
snd($sock_c, $port_a,  rtp(8, 3005, 5800, 0x1a04, "\x88" x 160));
rcv($sock_a, $port_c, rtpm(8, 3005, 5800, 0x1a04, "\x88" x 160));
...
($sock_a, $sock_b) = new_call([qw(198.51.100.2 7010)], [qw(198.51.100.4 7012)]);

($port_a) = offer('PCM to RFC DTMF transcoding w asymmetric codecs control', {
		replace => ['origin'],
		codec => { mask => ['telephone-event'], accept => ['telephone-event'] },
}, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.1
s=tester
t=0 0
m=audio 7010 RTP/AVP 0 101
...
($port_b) = answer('PCM to RFC DTMF transcoding w asymmetric codecs control', {
		replace => ['origin'],
}, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.3
...
snd($sock_b, $port_a,  rtp(0, 1004, 3000+160*4, 0x1234, ""));
# DTMF detected now
rcv($sock_a, $port_b, rtpm(101 | 0x80, $seq+4, 3000+160*4, $ssrc, "\x08\x0f\x00\xa0", "\x08\x10\x00\xa0")); # start event 8, vol -15, duration 160
snd($sock_b, $port_a,  rtp(0, 1005, 3000+160*5, 0x1234, "\x00" x 160));
# reverting to audio, but DTMF event still progressing
rcv($sock_a, $port_b, rtpm(101, $seq+5, 3000+160*4, $ssrc, "\x08\x0f\x01\x40", "\x08\x10\x01\x40")); # event 8, vol -15, duration 320
snd($sock_b, $port_a,  rtp(0, 1006, 3000+160*6, 0x1234, "\x00" x 160));
# end event, 3 times
rcv($sock_a, $port_b, rtpm(101, $seq+6, 3000+160*4, $ssrc, "\x08\x8f\x01\xe0", "\x08\x90\x01\xe0")); # end event 8, vol -15, duration 480
rcv($sock_a, $port_b, rtpm(101, $seq+7, 3000+160*4, $ssrc, "\x08\x8f\x01\xe0", "\x08\x90\x01\xe0")); # end event 8, vol -15, duration 480
rcv($sock_a, $port_b, rtpm(101, $seq+8, 3000+160*4, $ssrc, "\x08\x8f\x01\xe0", "\x08\x90\x01\xe0")); # end event 8, vol -15, duration 480
# audio passing through again
snd($sock_b, $port_a,  rtp(0, 1007, 3000+160*7, 0x1234, "\x00" x 160));
rcv($sock_a, $port_b, rtpm(0, $seq+9, 3000+160*7, $ssrc, "\x00" x 160));

snd($sock_a, $port_b,  rtp(0, 2000, 4000, 0x5678, "\x00" x 160));
($seq, $ssrc) = rcv($sock_b, $port_a, rtpm(0, -1, 4000, -1, "\x00" x 160));
snd($sock_a, $port_b,  rtp(0, 2001, 4000+160, 0x5678, "\x00" x 160));
rcv($sock_b, $port_a, rtpm(0, $seq+1, 4000+160, $ssrc, "\x00" x 160));
snd($sock_a, $port_b,  rtp(101, 2002, 4000+320, 0x5678, "\x08\x10\x00\xa0"));
rcv($sock_b, $port_a, rtpm(0, $seq+2, 4000+320, $ssrc, ""));
snd($sock_a, $port_b,  rtp(101, 2003, 4000+320, 0x5678, "\x08\x10\x01\x40"));
rcv($sock_b, $port_a, rtpm(0, $seq+3, 4000+480, $ssrc, ""));
snd($sock_a, $port_b,  rtp(101, 2004, 4000+320, 0x5678, "\x08\x90\x01\xe0")); # end event to get out of DTMF state
rcv($sock_b, $port_a, rtpm(0, $seq+4, 4000+640, $ssrc, ""));
# test out of seq
snd($sock_a, $port_b,  rtp(0, 2006, 4000+160*25, 0x5678, "\x00" x 160)); # processed because TS difference too large
rcv($sock_b, $port_a, rtpm(0, $seq+6, 4000+160*5, $ssrc, "\x00" x 160));
snd($sock_a, $port_b,  rtp(101, 2005, 4000+320, 0x5678, "\x08\x10\x01\xe0")); # repeat, no-op, dup, consumed
# resume normal
snd($sock_a, $port_b,  rtp(0, 2007, 4000+160*26, 0x5678, "\x00" x 160));
rcv($sock_b, $port_a, rtpm(0, $seq+7, 4000+160*6, $ssrc, "\x00" x 160));
# test TS reset
snd($sock_a, $port_b,  rtp(0, 2008, 2000, 0x5678, "\x00" x 160));
rcv($sock_b, $port_a, rtpm(0, $seq+8, 4000+160*7, $ssrc, "\x00" x 160));
snd($sock_a, $port_b,  rtp(101, 2009, 2160, 0x5678, "\x08\x10\x00\xa0"));
rcv($sock_b, $port_a, rtpm(0, $seq+9, 4000+160*8, $ssrc, ""));




($sock_a, $sock_b) = new_call([qw(198.51.100.5 7010)], [qw(198.51.100.7 7012)]);

($port_a) = offer('PCM to RFC DTMF transcoding w asymmetric codecs', {
		replace => ['origin'],
		codec => { mask => ['telephone-event'], accept => ['telephone-event'] },
}, <<SDP);
v=0
...
($port_b) = answer('PCM to RFC DTMF transcoding w asymmetric codecs', {
		replace => ['origin'],
		flags => ['allow asymmetric codecs'],
}, <<SDP);
v=0
...
($sock_a, $sock_b) = new_call([qw(198.51.100.2 7050)], [qw(198.51.100.4 7052)]);

($port_a) = offer('reverse DTMF transcoding w asymmetric codecs control', {
		replace => ['origin'],
		codec => { mask => ['telephone-event'], accept => ['telephone-event'] }
}, <<SDP);
v=0
...
($port_b) = answer('reverse DTMF transcoding w asymmetric codecs control', {
		replace => ['origin'],
}, <<SDP);
v=0
o=- 1545997027 1 IN IP4 198.51.100.4
...
($sock_a, $sock_b) = new_call([qw(198.51.100.5 7050)], [qw(198.51.100.7 7052)]);

($port_a) = offer('reverse DTMF transcoding w asymmetric codecs', {
		replace => ['origin'],
		codec => { mask => ['telephone-event'], accept => ['telephone-event'] }
}, <<SDP);
v=0
...
($port_b) = answer('reverse DTMF transcoding w asymmetric codecs', {
		replace => ['origin'],
		flags => ['allow asymmetric codecs'],
}, <<SDP);
v=0
