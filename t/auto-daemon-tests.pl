...
my ($sock_a, $sock_b, $sock_ax, $sock_bx,
	$port_a, $port_b, $port_ax, $port_bx,
	$ssrc, $resp, $srtp_ctx_a, $srtp_ctx_b, @ret1, @ret2, $ts, $seq);
...
@ret1 = rcv($sock_ax, $port_bx, qr/^\x81\xc8\x00\x0c(.{4})(.{4})(.{4})(.{4})\x00\x00\x00\x01\x00\x00\x00\xac\x00\x00\x12\x34\x00\x00\x00\x00\x00\x00\x00\x00(.*)$/s);
# 81c8000c 2052ab28 e2309570 a53e707d 6250e8fd 00000001 000000ac 00001234 00000000 00000000 00000000000000000000000081ca00052052ab28010c3561623831643131336533340000
