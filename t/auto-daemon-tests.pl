...
rcv($sock_a, $port_b, rtpm(0, $seq+2, 4000+160*12, $ssrc, ")" x 160));
snd($sock_b, $port_a,  rtp(8, 62012, 4000+160*13, 0x5678, "\x00" x 160));
rcv($sock_a, $port_b, rtpm(0, $seq+3, 4000+160*13, $ssrc, ")" x 160));
snd($sock_b, $port_a,  rtp(0, 62013, 4000+160*14, 0x5678, "\x00" x 160));
rcv($sock_a, $port_b, rtpm(0, $seq+4, 4000+160*14, $ssrc, "\x00" x 160));
...
# test out of seq
snd($sock_b, $port_a,  rtp(0, 2006, 4000+800, 0x5678, "\x00" x 160)); # buffered
