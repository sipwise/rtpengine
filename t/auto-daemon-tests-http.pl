...
my ($sock_a, $sock_b, $port_a, $port_b, $resp, $seq, $ts, $ssrc, @ret1, @ret2);


($sock_a, $sock_b) = new_call(
	[qw(198.51.100.1 7400)],
	[qw(198.51.100.3 7402)],
);

($port_a) = offer('play media', { }, <<SDP);
v=0
