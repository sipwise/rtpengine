...
struct t38_gateway {
	...
	unsigned int udptl_ec_entries;
	unsigned int udptl_fec_span; // 1 means no FEC
...
int t38_gateway_input_samples(struct t38_gateway *, struct media_packet *, int16_t amp[], int len);
int t38_gateway_input_udptl(struct t38_gateway *, struct media_packet *, const str *);
